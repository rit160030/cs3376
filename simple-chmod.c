 ...
 *   the use of the chmod(2) system call,
 *   and how it can be used to set explicit/absolute modes
 *   or to selectively enable individual modes.
 *
 *   Set your umask to 077, create foo and foo1, 
 *   then run this command (program).
 *
 */
